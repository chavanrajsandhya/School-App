...
class BatchesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create batch" do
    assert_difference('Batch.count') do
      post batches_url, params: { batch: { end_time: @batch.end_time, name: @batch.name, no_of_students: @batch.no_of_students, start_time: @batch.start_time } }
    end
  ...
  test "should update batch" do
    patch batch_url(@batch), params: { batch: { end_time: @batch.end_time, name: @batch.name, no_of_students: @batch.no_of_students, start_time: @batch.start_time } }
